        ...
        _c("div", { staticClass: "lg:w-3/5 w-full" }, [
          _c("div", { staticClass: "flex flex-row justify-between pb-4" }, [
            _c(
              ...
              {
                staticClass:
                  "text-sm font-semibold text-white px-2 py-1 rounded-md cursor-pointer",
                class:
                  "border border-" +
                  _vm.blog.channel.color +
                  "-600 text-" +
                  _vm.blog.channel.color +
                  "-500 hover:text-" +
                  _vm.blog.channel.color +
          ...
          _c(
            ...
            {
              staticClass:
                "text-2xl lg:text-3xl text-gray-700 font-bold pb-4 leading-tight"
            },
            [_vm._v("\n        " + _vm._s(_vm.blog.title) + "\n      ")]
          ),
          _vm._v(" "),
          _vm.blog.summary
            ? _c("p", { staticClass: "text-lg pb-8 text-gray-700" }, [
        ...
        _c("div", { staticClass: "lg:w-2/5 w-full flex flex-col lg:pl-12" }, [
          ...
          _c(
            ...
            [
              _c(
                "p",
                { staticClass: "text-gray-700 mb-4 text-xl font-semibold" },
                [
                  _vm._v(
                ...
                return _c(
                  ...
                  [
                    ...
                    _c(
                      ...
                      {
                        staticClass:
                          "text-gray-600 text-md hover:text-gray-700",
                        attrs: { href: "/blog/" + relatedBlog.slug }
                      },
                      [
                        _vm._v(
                          "\n            " +
...
var render = function() {
  ...
  return _c("div", { staticClass: "flex flex-col" }, [
    ...
    _c("hr", {
      staticClass:
        "bg-gray-700 h-1 shadow-lg rounded-lg mt-2 ml-2 hidden lg:flex"
    })
  ])
}
var staticRenderFns = []
