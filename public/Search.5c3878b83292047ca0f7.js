          ...
          [
            ...
            _c("div", { staticClass: "p-2" }, [
              _c(
                ...
                {
                  staticClass:
                    "bg-gray-500 text-white rounded-full p-2 hover:bg-gray-400 focus:outline-none w-12 h-12 flex items-center justify-center",
                  attrs: { type: "submit" },
                  on: {
    ...
    _c("div", { staticClass: "p-2 lg:hidden" }, [
      !_vm.showInput
        ? _c(
            ...
            {
              staticClass:
                "bg-gray-500 text-white rounded-full p-2 hover:bg-gray-400 focus:outline-none w-12 h-12 flex items-center justify-center cursor-pointer",
              on: {
                click: function($event) {
                  $event.preventDefault()
                  _vm.showInput = true
