...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "flex flex-1 flex-col lg:flex-row shadow-md p-2 rounded-lg cursor-pointer hover:bg-gray-100 ease-in-out duration-300 transform bg-white",
      on: {
        click: function($event) {
          $event.preventDefault()
      ...
      _c("div", { staticClass: "flex flex-col flex-1" }, [
        ...
        _c("div", { staticClass: "mt-1 mb-2" }, [
          _c("p", { staticClass: "text-sm text-gray-500" }, [
            _c("a", { staticClass: "text-blue-700 text-sm" }, [
