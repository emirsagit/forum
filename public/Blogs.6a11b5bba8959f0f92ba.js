...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "bg-gradient-to-b from-gray-100 to-gray-200" },
    [
      _c("div", { attrs: { id: "last-published" } }, [
          ...
          _c("div", { staticClass: "flex md:flex-row flex-col flex-wrap" }, [
            _vm.blogs.length
              ? _c(
                  ...
                  {
                    staticClass:
                      "md:w-1/2 w-full flex flex-col pb-8 md:pr-8 transform hover:scale-105 transition duration-500 ease-in-out"
                  },
                  [
                    _c("img", {
                      staticClass: "rounded-md cursor-pointer shadow-xl",
                      attrs: {
                    ...
                    _c(
                      ...
                      {
                        staticClass:
                          "-mt-6 text-white text-xs px-1 table rounded-md font-bold z-30 cursor-pointer",
                    ...
                    _c(
                      "span",
                      { staticClass: "text-gray-600 font-light text-lg" },
                      [_vm._v(_vm._s(_vm.blogs[0].updated_at))]
                    )
                  ]
                )
              : _vm._e(),
                  ...
                  [
                    index !== 0
                      ? _c(
                          ...
                          {
                            staticClass:
                              "w-1/2 md:pt-0 flex flex-col transform hover:scale-105 transition duration-500 ease-in-out"
                          },
                          [
                            _c("img", {
                              staticClass:
                                "lg:rounded-md rounded-t-md cursor-pointer shadow-xl",
                              attrs: {
                            ...
                            _c(
                              ...
                              {
                                staticClass:
                                  "lg:-mt-6 text-center mt-0 text-xs px-1 lg:rounded-md rounded-b-md table text-white font-bold z-30 w-full lg:w-auto cursor-pointer",
                    ...
                    index !== 0
                      ? _c(
                          ...
                          {
                            staticClass:
                              "w-1/2 px-2 md:pl-4 justify-center flex flex-col"
                          },
                          [
                            _c(
                              "a",
                            ...
                            _c(
                              "span",
                              {
                                staticClass: "text-gray-600 font-light text-sm"
                              },
      ...
      _c("div", { attrs: { id: "trendings" } }, [
        _c("div", { staticClass: "flex flex-col lg:flex-row" }, [
                    ...
                    _c(
                      ...
                      [
                        _c(
                          ...
                          [
                            _c(
                              ...
                              {
                                staticClass:
                                  "font-bold md:text-xl text-lg hover:text-gray-800 transition duration-500 ease-in-out cursor-pointer leading-tight",
                                on: {
                                  click: function($event) {
                                    return _vm.goto(trending)
                                  }
                        ...
                        _c(
                          "span",
                          { staticClass: "text-gray-600 font-light text-sm" },
                          [_vm._v(_vm._s(trending.updated_at))]
                        )
                      ]
                    )
                  ]
          ...
          _c(
            "div",
            { staticClass: "lg:w-1/4 w-full p-4 lg:p-8 lg:pr-24 rounded-lg" },
            [
              _c(
                "p",
              ...
              _c(
                ...
                _vm._l(_vm.threads, function(thread) {
                  return _c("a", {
                    key: thread.id,
                    staticClass:
                      "py-2 text-lg text-teal-700 hover:text-teal-800",
