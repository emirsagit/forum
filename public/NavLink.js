...
var staticRenderFns = [
  function() {
    ...
    return _c(
      ...
      {
        staticClass:
          "flex flex-col items-center justify-around lg:w-2/3 uppercase absolute top-0 lg:static w-full border-b-2 border-teal-800 transition duration-500 ease-in-out lg:border-none"
      },
      [
        _c(
          "a",
