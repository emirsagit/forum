<template>
  <div class="mt-6 flex flex-row">
    <a
      :href="facebook"
      class="bg-white text-blue-700 hover:text-blue-800 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2 p-1 flex cursor-pointer"
      type="button"
    >
      <svg
    ...
    <a
      :href="twitter"
      class="bg-white text-blue-600 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2 p-1 flex hover:text-blue-700 cursor-pointer"
      type="button"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
